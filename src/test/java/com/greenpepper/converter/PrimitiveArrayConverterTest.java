...
public class PrimitiveArrayConverterTest extends TestCase
{   
    public void testShouldConvertPrimitiveBoolArrays()
    {
        ...
        assertTrue( Arrays.equals( new boolean[]{true, false, true}, (boolean[]) converter.parse( "true, false, true", boolean[].class ) ) );
    ...
    public void testShouldConvertPrimitiveDoubleArrays()
    {
        ...
        assertTrue( Arrays.equals( new double[]{1.51, 2.23, 3}, (double[]) converter.parse( "1.51, 2.23, 3", double[].class ) ) );
